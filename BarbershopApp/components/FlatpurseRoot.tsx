        ...
        {activeTab === "AI" && (
          <div style={{ padding: "14px 20px 28px" }}>
            ...
            <div style={{ padding: "14px 16px", borderRadius: 13, background: t.accentSoft, border: `1px solid ${t.accent}20`, marginBottom: 14 }}>
              ...
              {c.churnRisk === "high" && (
                <button onClick={() => setWinbackSent(!winbackSent)} style={{ width: "100%", padding: "11px 0", borderRadius: 11, background: winbackSent ? t.greenBg : t.accent, border: winbackSent ? `1px solid ${t.green}` : "none", cursor: "pointer", fontFamily: f, fontSize: 13, fontWeight: 700, color: winbackSent ? t.greenText : "#fff" }}>
                  {winbackSent ? "✓ Win-back sent" : "Send win-back now →"}
                </button>
              )}
            </div>
    ...
    <div style={{ position: "absolute", inset: 0, zIndex: 100, borderRadius: 44, overflow: "hidden", background: t.bg, display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ flex: 1, overflowY: "auto", WebkitOverflowScrolling: "touch", padding: "0 20px 24px" }}>
        ...
        <div style={{ padding: "14px 16px", borderRadius: 14, background: t.card, border: `1px solid ${t.border}`, marginBottom: 20, boxShadow: t.shadow }}>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            {winBackSent
              ? <div style={{ padding: "8px 16px", borderRadius: 10, background: t.greenBg, color: t.greenText, fontSize: 13, fontWeight: 700 }}>✓ Win-back sent</div>
              : <>
                  <button onClick={() => setWinBackSent(true)} style={{ padding: "8px 16px", borderRadius: 10, background: t.accent, color: "#fff", border: "none", fontSize: 13, fontWeight: 700, cursor: "pointer", fontFamily: f }}>Send win-back</button>
                  <button style={{ padding: "8px 16px", borderRadius: 10, background: "transparent", color: t.text, border: `1px solid ${t.border}`, fontSize: 13, fontWeight: 600, cursor: "pointer", fontFamily: f }}>Skip</button>
                </>
            }
          </div>
        </div>
            ...
            <div style={{ padding: "13px 14px", borderRadius: 13, background: t.card, border: `1px solid ${t.border}`, marginBottom: 18 }}>
              <div style={{ display: "flex", alignItems: "flex-start", gap: 10 }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ display: "flex", gap: 8 }}>
                    {winBackSent
                      ? <div style={{ padding: "7px 14px", borderRadius: 9, background: t.greenBg, color: t.greenText, fontSize: 12, fontWeight: 700, fontFamily: ebf }}>✓ Win-back sent</div>
                      : <>
                          <button onClick={() => setWinBackSent(true)} style={{ padding: "7px 14px", borderRadius: 9, background: t.accent, color: "#fff", border: "none", fontSize: 12, fontWeight: 700, cursor: "pointer", fontFamily: ebf }}>Send win-back</button>
